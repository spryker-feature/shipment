...
- [ShipmentTypesBackendApi ^0.3.0](https://github.com/spryker/shipment-types-backend-api) (Glue Backend)
- [ShipmentTypesRestApi ^0.3.0](https://github.com/spryker/shipment-types-rest-api) (Legacy Glue)
